...
# debian-iso-builder-respin-sway
...
| `+` | `+` |
| [debian-iso-builder-remix-sway](https://samwhelp.github.io/debian-iso-builder-remix-sway/) | [GitHub](https://github.com/samwhelp/debian-iso-builder-remix-sway) |
| `=` | `=` |
| [debian-iso-builder-respin-sway](https://samwhelp.github.io/debian-iso-builder-respin-sway/) | [GitHub](https://github.com/samwhelp/debian-iso-builder-respin-sway) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-respin-sway/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-respin-sway/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-respin-sway/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-respin-sway](https://github.com/samwhelp/debian-iso-builder-respin-sway)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-respin-sway.git
```


> change dir to `debian-iso-builder-respin-sway`

``` sh
cd debian-iso-builder-respin-sway
```
...
> The resulting ISO file will be placed on `debian-iso-builder-remix-sway/dist`
...
| [Sway / Note](https://samwhelp.github.io/note-about-sway/) | [GitHub](https://github.com/samwhelp/note-about-sway) |
